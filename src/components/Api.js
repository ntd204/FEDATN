...
//       import.meta.env.REACT_API_GEOAPIFY
//     }`,
//   });

import React, { useEffect, useRef, useState } from "react";
import { REACT_APP_MAP_API } from "../constants/constants";
...
const SearchLocationInput = ({ setSelectedLocation }) => {
  ...
  useEffect(() => {
    loadScript(
      `https://maps.googleapis.com/maps/api/js?key=${REACT_APP_MAP_API}&libraries=places`,
